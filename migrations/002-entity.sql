...
VALUES 
('AddressLine', '#80ff80', 'Location', 'Regular expression', '\b(?:\d+[a-z]*)\s(?:[''\.\-\w]*)\s(?:approach|avenue|bank|close|cl|crescent|croft|court|drive|east|end|field|heights|ga?r?de?ns|gate|grange|green|grove|hill|lane|ln|meadow|mews|north|parade|park|path|place|pl|rise|road|rd|row|square|south|street|st|terrace|view|walk|way|west|wood|yard)\b'),
