...
(
  'Address2',  '#80ff70', 'Location', 0, 'LOCATION',
  'Regular expression', '\b(?:Suite\s(?:\w+)|\d+(st|nd|rd|th)\sFloor)\b'
),
(
...
(
  ...
  'Regular expression', '\b(?:jan\.?|janu?a?ry|feb\.?|febr?ua?ry|mar\.?|march|apr\.?|april|may|jun\.?|june|jul\.?|july|aug\.?|august|sept?\.?|september|oct\.?|october|nov\.?|november|dec\.?|december)(?:(?:[\s\-\.]{0,3})(?:\d\d|\d\d\d\d))(?:[\s\-\.,]{0,3}\d\d\d\d)?\b'
),
(
...
(
  'Person',    '#0080ff', 'Person',   0, 'PERSON', 'Single term', ''
),
(
  'PlaceName', '#80ff00', 'Location', 0, 'LOCATION', 'Multiple term', ''
),
(
...
(
  'Territory','#80ff80', 'Location', 0, 'LOCATION', 'Multiple term', ''
),
(
