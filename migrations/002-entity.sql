...
(
  'Address', '#80ff70', 'Name', 'LOCATION', 'Regular expression',
  1, 1, 1, 2,
  '\b(?:abbey|acres?|airfield|alley|allotments?|approach|arcade|avenue|b[ae]ck|banks?|barns?|basin|bay|beach|beacons?|bog|bottoms?|boulevard|braes?|brake|bridges?|broads?|brooks?|buildings?|bush(?:es)?|bypass|camp(?:us)?|canal|castle|causeway|cave|centre|channel|chapel|church|circ(?:le|us)|circular|city|cliff(?:e|s)?|close|clumps?|coast|colliery|commons?|convent|coppices?|copses?|corner|cottages?|court(?:yard)?|cove(?:rts?)?|crags?|creek|crescent|crest|crofts?|cross(?:ing)?|dales?|dam|d[iy]ke|district|ditch|docks?|downs?|drift|dr[io]ve|edge|embankment|entrance|esplanade|estates?|farms?|f[ae]lls?|fens?|ferry|field|flats?|fo[lr]ds?|furzes?|gap|gardens?|gate(?:s|way)?|geos?|glens?|gorse|grange|grass|great|greens?|grounds?|groves?|gully|h[ai]lls?|hanger|harbour|hatch|haven|head|heaths?|hedges?|heights?|high(?:way)?|hollow|holt|houses?|interchange|islands?|isles?|jetty|junctions?|la[kn]es?|lawns?|level|leys?|links?|little|loch|l[eo]dge|lower|manor|market|marsh(?:es)?|meadows?|meade?s?|mere|mews|m[ai]lls?|moat|moors?|moss|mounts?|mouth|ness|orchards?|oval|paddocks?|parade|park(?:land|s|way)?|pass(?:age)?|passageway|pastures?|path|piece|pier|p[iy]ke|pit|place|plains?|ponds?|pools?|point|port|priory|promenade|quad(?:rant)?|quarry|quays?|range|rd|reach|reservoir|ri[ds]e|rivers?|roads?|rocks?|rough|round(?:about)?|row|sands?|sea|sh[io]re|side|skerr(?:y|ies)|sound|spa|spinneys?|springs?|spur|square|station|strand|stream|street|strip|summit|tarns?|terraces?|to[pr]s?|towers?|towns?|trail|tunnel|upper|vale|valley|views?|villas?|villages?|wal[kl]s?|water(?:s|falls?)?|ways?|weald|well|weirs?|wharf|wold|wood(?:s|lands)?|yards?)\b',
