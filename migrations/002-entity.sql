...
(
  'Address', '#80ff70', 'Name', 'LOCATION', 'Regular expression',
  1, 1, 1, 2,
  '\b(?:abbey|acres?|airfield|alley|allotments?|approach|arcade|avenue|b[ae]ck|banks?|barns?|basin|bay|beach|beacons?|belt|bog|bottoms?|boulevard|braes?|brake|bridges?|broads?|brooks?|buildings?|bush(?:es)?|bypass|camp(?:us)?|canal|castle|causeway|cave|centre|channel|chapel|church|circ(?:le|us)|circular|city|cliff(?:e|s)?|close|clumps?|coast|colliery|commons?|convent|coppices?|copses?|corner|cottages?|court(?:yard)?|cove(?:rts?)?|crags?|creek|crescent|crofts?|cross(?:ing)?|dales?|dam|d[iy]ke|district|ditch|docks?|downs?|drift|dr[io]ve|edge|embankment|entrance|esplanade|estates?|farms?|f[ae]lls?|fens?|ferry|field|flats?|fo[lr]ds?|folly|furzes?|gap|gardens?|gate(?:s|way)?|geos?|glens?|gorse|grange|grass|great|greens?|grounds?|groves?|gully|h[ai]lls?|hanger|harbour|hatch|haven|head|heaths?|hedges?|heights?|highways?|hollow|hole|houses?|interchange|islands?|isles?|jetty|junctions?|la[kn]es?|lawns?|level|leys?|links?|little|loan|loch|l[eo]dge|mains|manor|market|marsh(?:es)?|meadows?|meade?s?|mere|mews|m[ai]lls?|moat|moors?|moss|mounts?|mouth|ness|orchards?|oval|paddocks?|parade|park(?:land|s|way)?|pass(?:age)?|passageway|pastures?|patch|path|peak|piece|pier|p[iy]ke|pit|place|plains?|ponds?|pools?|point|porth?|priory|promenade|quad(?:rant)?|quarry|quays?|range|rd|reach|reservoir|ri[ds]e|rivers?|roads?|rocks?|rough|round(?:about)?|row|sand|sea|sh[io]re|side|skerr(?:y|ies)|sound|spa|spinneys?|springs?|spur|square|station|strand|stream|street|strip|summit|tarns?|terraces?|to[pr]s?|towers?|towns?|track|trail|tunnel|upper|vale|valleys?|views?|villas?|villages?|wal[kl]s?|water(?:s|falls?)?|ways?|weald|well|weirs?|wharf|wick|wood(?:s|lands)?|yards?)\b',
...
(
  ...
  1, 0, 0, 2,
  '[$£€]\s*\d[\d,]*(?:\.\d{1,2})?(?:\s?[billion|k|m|million|trillion])?\b',
  'Example: £23,000 or $30k'
),
(
  'Currency2', '#334320', 'Currency', 'CURRENCY', 'Regular expression', 
  1, 0, 0, 2,
  '\d[\d,\.]*(?:\s[b|m|tr]illion|k|p)?\s?(?:pounds?|pence|euros?|dollars?|cents?)\b',
...
(
  ...
  1, 0, 1, 2,
  '\b[a-z]+t(?:a[acdfh-koqu-wz]|c[a-gi-z]|e[bcf-hjkoqu-wz]|h[b-df-hj-ln-rt-xz]|i[bfhi-kqu-z]|l[a-df-xz]|o[a-df-ktuvz]|r[b-df-np-su-xz]|s[a-fg-tv-xz]|t[b-df-np-rt-xz]|u[acf-oqt-z]|[bdfgjkmnpqv-z][a-z])\b',
...
(
  ...
  1, 1, 0, 1, 
  '[\d,\.]+(?:st|nd|rd|th)?[\s\-\\\/]{1,2}(?:acre|autumn|beer|count|crew|crime|day|fairway|hour|mile|page|pence|place|point|pound|metre|min|murder|star|story|student|summer|time|week|winter|yard|yr|year)s?',
  'Example: 23 acres'
),
(
...
(
  ...
  1, 1, 0, 1, 
  '\b(?:one|first|two|second|three|third|four|forth|five|fifth|six|seven|eight|nine|ten|hundred)[\s\-\\/]{1,2}(?:acre|autumn|beer|count|crew|crime|daughter|day|hour|mile|metre|murder|page|pence|place|point|pound|son|star|story|student|summer|time|week|winter|year)s?\b',
  'Example: Four beers'
),
(
