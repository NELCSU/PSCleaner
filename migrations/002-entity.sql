...
('MonthYear', '#00ff80', 'Time', 'Regular expression', '\b(?:jan|janu?a?ry|feb|febr?ua?ry|mar|march|apr|april|may|jun|june|jul|july|aug|august|sept?|september|oct|october|nov|november|dec|december)(?:(?:[\s\-\.]{0,3})(?:\d\d|\d\d\d\d))\b'),
...
('DateShort1', '#00ff90', 'Time', 'Regular expression', '\b[0123]?\d[\s\/]{1,3}[0123]?\d[\s\/]{1,3}\d{2,4}|\d{2,4}[\s\/]{1,3}[0123]?\d[\s\/]{1,3}[0123]?\d\b'),
('DateShort2', '#00ff90', 'Time', 'Regular expression', '\b[0123]?\d[\s\-]{1,3}[0123]?\d[\s\-]{1,3}\d{2,4}|\d{2,4}[\s\-]{1,3}[0123]?\d[\s\-]{1,3}[0123]?\d\b'),
('DateShort3', '#00ff90', 'Time', 'Regular expression', '\b[0123]?\d[\s\.]{1,3}[0123]?\d[\s\.]{1,3}\d{2,4}|\d{2,4}[\s\.]{1,3}[0123]?\d[\s\.]{1,3}[0123]?\d\b'),
('Email', '#ff8000', 'Contact', 'Regular expression', '\b(?:[\w+\-\_\.]+)@(?:[\w+\-\_\.]+)\b'),
('Firstname', '#2bbaff', 'Person', 'Single term', NULL),
('NHSNumber', '#0040cc', 'NHSNumber', 'Regular expression', '[34679]\d\d\s?\d\d\d\s?\d\s?\d\s?\d\s?\d'),
('PlaceName', '#00ff00', 'Location', 'Single term', NULL),
('Postcode', '#e9d696', 'Location', 'Regular expression', '\b(?:GIR|[a-zA-Z][a-zA-Z]?(?:[0-9][a-zA-Z]|[0-9]{1,2}))(?:[ ]{0,3})(?:[0-9][a-zA-Z]{2})\b'),
('Surname', '#0080ff', 'Person', 'Single term', NULL),
