...
const NameFragmentRegEx: RegExp[] = [
  ...
  /(?<=\b[A-Z][a-z]+-)(?:a[fn]|a|ba[cn]k|bar|beech|berth|big|bi|blew|brain|castle|ca[pr]|clip|corn|cut|doll|don|drain|dyke|d|earn|e[mn]|end|eye|e|fan|franc|fro|gains|gate|gest|glazier|grove|gun|go|hardy|hale|haul|heart|hen|hil[lt]|him|hole|hurt|h|is|m[ai]|men|mere|moors|marriage|nah|o[dln]|over|pennant|pant|park|pica|post|p[ei]n|roe|ri|'?r|sand|saint|shop|stent|stair|st|sub|super|tail|tore|t[ao]n|t|walk|y)\b/gmi,
];
