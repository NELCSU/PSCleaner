const a: RegExp[] = [
  ...
  /\bap{1,3}rox\b/gmi,
  /\bat\shome\b/gmi,
  /\b(?:between|from|in|in\sthe)\s(?:April|Jan|June|July|March|May|September)\s?(?:and|to|\-)\s?(?:April|Jan|June|July|March|May|September)\b/gmi,
  /\bthe\seve\sof\b/gmi,
  ...
  /\b(?:as|since)\s(?:(?:early(?:\sas)?|mid|late(?:\sas)?)[\s\-])?(?:April|Jan|June|July|May|September)\b/gmi,
  ...
  /\b(?:during|since|until)\s(?:(?:early|mid|late)[\s\-])?(?:April|Jan|June|July|March|May|September)\b/gmi,
  /\b(?:from|in)\s(?:(?:early|mid|late)[\s\-])?(?:April|Jan|June|July|May|September)\b/gmi,
