const a: RegExp[] = [
  ...
  /\ben\smasse\b/gmi,
  /\bet\scetera\b/gmi,
  /\b(?:beginning|beyond(?:\sthis)?|by|during|early|end(?:ed)?|from|in|in\sthe|mid|middle|last|late|on|since|start|the|until|(?:day|month|week)\sof)|(?:\s|\-|as|of)+(?:(?:Jan|Febr)uary|March|April|May|June|July|August|(?:Septem|Octo|Novem|Decem)ber|(?:Mon|Tues|Wednes|Thurs|Fri|Satur|Sun)day)\b/gmi,
