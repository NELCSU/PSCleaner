const a: RegExp[] = [
  ...
  /\b(?:after|as|before|beginning|between|beyond|by|day|during|early|end(?:ed|ing)?|for|from|if|in|mid(?:dle)?|month|last|late|on|since|start(?:ed|ing)?|the|till|to|until|week|when)(?:\s(?:and|of|this))?[\s\-](?:Jan(?:uary)?|February|March|April|May|June|July|August|(?:Septem|Octo|Novem|Decem)ber)(?:(?:and|through|to|\s|-)+(?:Jan(?:uary)?|February|March|April|May|June|July|August|(?:Septem|Octo|Novem|Decem)ber))?\b/gmi,
  /\b(?:after|as|before|beginning|between|beyond|by|day|during|early|end(?:ed|ing)?|for|from|if|in|mid(?:dle)?|last|late|on|since|start(?:ed|ing)?|the|till|to|until|week|when)(?:\s(?:and|of|this))?[\s\-](?:(?:Mon|Tues|Wednes|Thurs|Fri|Satur|Sun)day)(?:(?:and|through|to|\s|-)+(?:(?:Mon|Tues|Wednes|Thurs|Fri|Satur|Sun)day))?\b/gmi,
