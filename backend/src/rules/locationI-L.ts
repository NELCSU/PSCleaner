...
// IN
/\binner\s(?:alscott\scombe|anchorage|appledore\srocks|basin|bay|black\shill|blue\scarn|bracket['‘’`s]{1,2}\scoppice)\b/gmi,
/\binner\s(?:breakwater\sroad|brigurd\spoint|broady\scove|bucks|butt\shill|byre\scleuch|camber|cleu[cg]h)\b/gmi,
/\binner\s(?:colvel\srock|combe\srocks|croagle|dale|dodd|farne|fladdack|flaess|froward\spoint|ganges|gat|geo(?:\sof\sheog)?)\b/gmi,
/\binner\s(?:gosling\sclose|green\scleugh|grey\shill|gullands|hamar|hangie|hare\scleuch|haven|hebrides|hey)\b/gmi,
/\binner\s(?:hill|holm\sof\sskaw|holm|kimlers|lake|ling\sroad|london|loop\sroad|luff\sway|maynard['‘’`s]{1,2}\scopse)\b/gmi,
/\binner\s(?:mid\shill|moor\slane|nebbock|neck\sof\sgerwick|owers|park\sroad|pendower\scove|penlee\spoint|penny\sledge|plantation|promenade)\b/gmi,
/\binner\s(?:quickening\scleugh|rags|ranneys|redding|ring\s(?:east|road|west)|rock\sof\scarn\swethers|ruskock|scotland\splantation)\b/gmi,
/\binner\s(?:scouter\scleuch|scud|shag\srocks|silder\sskerry|sinni\sgeo|skerry|snow\scraig|taing|tarri\sgeos|temple\sgarden)\b/gmi,
/\binner\s(?:tidal\sbank|ting\stong|tod\shill|troola|tugbury\splantation|tumble\swick|virdik|voder|westland|wood\shill)\b/gmi,
/\bintac\swood\b/gmi,
...
/\bkey\s(?:and\scastle\syard|cleuch|copse|gardens|hill\sdrive|sike\slane|west(?:\sclose)?)\b/gmi,
...
/\b(?:glebe|godford|green\slane|hall|hart|haver|heathers|herrings|higher)\sland\b/gmi,
...
// LE
/\blegion\s(?:avenue|close|court|crescent|drive|field\screscent|grove|lane(?:\s(?:east|west))?|place|rise|road|street|terrace)\b/gmi,
/\blegion['‘’`s]{0,2}\sway\b/gmi,
/\bleeway\s(?:avenue|close|court|road)\b/gmi,
/\bleeks\s(?:close|hill)\b/gmi,
/\bleek\s(?:bus\sstation|college|cove|east|first\sschool|high\sspecialist\stechnology|hill\swood|lane|moorlands|new\sroad|north|old\sroad|road|rural|south|street|west|wootton)\b/gmi,
/\bleek['‘’`s]{0,2}\shill\b/gmi,
...
/\blead\s(?:flats|green|hill|lane|mill\slane|mills|mine\s(?:clough|moss)|moor|pool|road|stone|street|wath\swood)\b/gmi,
/\bleader\s(?:avenue|close|court|foot|kip|road|street|vale|valley|williams\sroad|wood)\b/gmi,
/\bleader['‘’`s]{1,2}\s(?:spinney|way)\b/gmi,
...
/\bLean\sLow\b/gm,
/\bleaner\sstack\b/gmi,
/\blean['‘’`s]{1,2}\swood\b/gmi,
...
/\b(?:leases\s(?:lane|road|wood)|(?:far|low)\sleases\slane)\b/gmi,
...
/\bletter\s(?:box\s(?:lane|wood)|daill|hill|moor|muir|road|wood)\b/gmi,
/\b(?:coed|loch|mealna)\sletter\b/gmi,
...
/\bHard\sLevel\sForce\b/gm,
/\blevel\sof\smendalgief\b/gmi,
/\blevel['‘’`s]{1,2}\sgreen\b/gmi,
/\bnew\slevel\shill\b/gmi,
/\bold\slevel\sway\b/gmi,
/\bthe\schaddock\slevel\b/gmi,
...
/\b(?:Knotty|Lavender|Long|Main|New|Pipe|Whiskey)\sLine\b/gm,
