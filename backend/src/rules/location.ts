...
const a: RegExp[] = [
  ...
  /\bdepartures\sroad\b/gmi,
  /\bdermatology\scentre\b/gmi,
  /\bdestination\sdrive\b/gmi,
  ...
  /\b(?:The\sEngine(?:\s[Gg]reen)?|Engine\s(?:[Bb]elt|[Dd]rove|[Ff]old|[Hh]ouse|[Ss]hed|[Ss]pring|[Yy]ard))\b/gm,
