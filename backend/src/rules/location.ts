...
const a: RegExp[] = [
  ...
  /\bThe\s(?:Arm|Banks?|Beast|Big\sAct|Bus|Cheeses|Climb|Cop|Crusades|Curtain|Engine(?:\sGreen)?|Fall|Front|God\sAlmighty|Heritage|Hornets?|Horses?|Kiosk|Knees?|Line|Lottery|Man\so\'?\sWar|Medical\sWing|Mere|Old\s(?:Fire\sStation|Laundry|Mission)|Post|Rangers|Rifles|Roundabouts?|Slides?|State\sHospital|Still|Style|Toe|Vikings|Watch|Waterwheel)\b/gm,
  ...
  /\b(?:brief|pitfall|privilege)\sstreet\b/gmi,
  /\bPolice\sStreet\b/gm,
  ...
  /\b(?:East|[Ff]orest|[Hh]olywell|Main|North|River|Sea|South)\sFront\b/gm,
