...
const a: RegExp[] = [
  ...
  /\bThe\s(?:Altars|Aquadrome|Arm|Banks?|Baulks|Beast|Beehive|Bench|Berries|Big\sAct|Blade|Bowl|Breaches|Breeze|Broads?|Bus|Cable|Cheeses|Climb|Coast\sGuards|Cop|Crusades|Curtain|Deep|Engine(?:\sGreen)?|Fall|First|Forum|Front|God\sAlmighty|Guards?|Gulf|Heritage|(?:Old\s)?High|Highlight|Hornets?|Horses?|Kiosk|Knees?|Line|Lottery|Man\so'?\sWar|Mary\sRose|Medical\sWing|Mere|Old|Old\s(?:Fire\sStation|Laundry|Mission)|Opening|Post|Rangers|Resolution|Rifles|Road|Roundabouts?|Old\sSaw\sMill|Saw\sMills|Shot|Slides?|Square|State\sHospital|Still|Street|Style|Tennis|Tennis\sCourt|Third|Toe|Vikings|Village|Wall|Watch|Waterwheel)\b/gm,
  ...
  /\b(?:athletes|citizens|crusader?s?|digital|godlings|logistics|habitat|media|origin|people\spark|taxi)\sway\b/gmi,
  /\b(?:Colonial|European|Independent|Scandinavian|Warriors)\sWay\b/gm,
  // wood
  /\b(?:abdication|aggravation|amphitheatre|backward|barriers|baskets|bristles|butteries|buttocks\sbank|fortification|funny[\s\-]shaped|guesses|little\sbeauties|schemes|twentynine)\swood\b/gmi,
