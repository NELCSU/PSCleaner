...
const a: RegExp[] = [
  ...
  /\bThe\s(?:Altars|Aquadrome|Arm|Banks?|Baulks|Beast|Beehive|Bench|Berries|Big\sAct|Blade|Bowl|Breaches|Breeze|Broads?|Bus|Cheeses|Climb|Coast\sGuards|Cop|Crusades|Curtain|Deep|Engine(?:\sGreen)?|Fall|First|Forum|Front|God\sAlmighty|Guards?|Gulf|Heritage|(?:Old\s)?High|Highlight|Hornets?|Horses?|Kiosk|Knees?|Line|Lottery|Man\so'?\sWar|Mary\sRose|Medical\sWing|Mere|Old|Old\s(?:Fire\sStation|Laundry|Mission)|Opening|Post|Rangers|Resolution|Rifles|Road|Roundabouts?|Old\sSaw\sMill|Saw\sMills|Shot|Slides?|Square|State\sHospital|Still|Street|Style|Tennis|Tennis\sCourt|Third|Toe|Vikings|Village|Wall|Watch|Waterwheel)\b/gm,
