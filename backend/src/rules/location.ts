...
const a: RegExp[] = [
  ...
  /\b(?:armourers|batteries|beekeeper|culture|hybrid|wooded)\sclose\b/gmi,
  ...
  /\b(?:abdication|aggravation|amphitheatre|backward|fortification|funny[\s\-]shaped|guesses|little\sbeauties|schemes|twentynine)\swood\b/gmi,
  ...
  /\bAll\sAlone\b/gm,
  /\b(?:alt[ae]rs\sof\slinnay|point\sof\sthe\salt[ae]r)\b/gmi,
