...
const a: RegExp[] = [
  ...
  /\bThe\s(?:Altars|Aquadrome|Arm|Banks?|Baulks|Beast|Beehive|Bench|Berries|Big\sAct|Blade|Bowl|Breaches|Breeze|Broads?|Bus|Cable|Carts|Cast|Cheeses|Circuit|Clearings|Clears|Climb|Clamps|Cleats|Coast\sGuards|Cop|Crusades|Curtain|Deep|Engine(?:\sGreen)?|Fall|First|Forum|Front|God\sAlmighty|Guards?|Gulf|Heritage|(?:Old\s)?High|Highlight|Hornets?|Horses?|Kiosk|Knees?|Line|Lottery|Man\so'?\sWar|Mary\sRose|Medical\sWing|Mere|Old|Old\s(?:Fire\sStation|Laundry|Mission)|Opening|Post|Rangers|Resolution|Rifles|Road|Roundabouts?|Old\sSaw\sMill|Saw\sMills|Shot|Slides?|Square|State\sHospital|Still|Street|Style|Tennis(?:\sCourt)?|Third|Toe|Treehouse|Vikings|Village|Wall|Watch|Waterwheel|Wheel)\b/gm,
  ...
  /\b(?:anglican|armorer|cotoneaster|silicon)\scourt\b/gmi,
  ...
  // way
  /\b(?:athletes|chariots|citizens|crusader?s?|digital|godlings|logistics|habitat|media|origin|people\spark|taxi)\sway\b/gmi,
