export const NamesEndingRegEx: RegExp[] = [
   ...
   /\b[a-z]+b[cdfhjkmpsw-z][a-z]\b/gmi,
   ...
   /\b[a-z]+j[a-ik-ps-vxy][a-z]\b/gmi,
   /\b[a-z]+j[jz][adeiouy]\b/gmi,
   /\b[a-z]+j[rw][aeiou]\b/gmi,

   /\b[a-z]+ka[a-z]\b/gmi,
   /\b[a-z]+k[b-df-hjmp-rtv-z][a-z]\b/gmi,
   ...
   /\b[a-z]+mc[b-z]\b/gmi,
   /\b[a-z]+m[fgjrsvwz][a-z]\b/gmi,
   /\b[a-z]+m[dq][a-prt-z]\b/gmi,
   /\b[a-z]+me[a-ce-kmo-qu-z]\b/gmi,
   /\b[a-z]+mh[a-pr-wyz]\b/gmi,
   /\b[a-z]+mi[bf-kmo-ru-z]\b/gmi,
   /\b[a-z]+mk[abd-pr-y]\b/gmi,
   /\b[a-z]+ml[a-pr-xz]\b/gmi,
