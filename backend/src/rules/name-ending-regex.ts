export const NamesEndingRegEx: RegExp[] = [
   ...
   /\b[a-z]+[u-z]che\b/gmi,
   /\b[a-z]+[ejknqw-z]cia\b/gmi,
   /\b[a-z]+[iv]cic\b/gmi,
   /\b[a-z]+[a-clnx-z]cio\b/gmi,
   /\b[a-z]+ucla\b/gmi,
   ...
   /\b[a-z]+ceby\b/gmi,
   /\b[a-z]+[ix-z]eca\b/gmi,
   /\b[a-z]+[bilu-z]ech\b/gmi,
   /\b[a-z]+[bu]eck\b/gmi,
   /\b[a-z]+[imx-z]ede\b/gmi,
   /\b[a-z]+[cfx-z]edo\b/gmi,
   /\b[a-z]+[mx-z]eed\b/gmi,
   /\b[a-z]+[bf]eek\b/gmi,
   ...
   /\b[a-z]+[cx-z]hon\b/gmi,
   /\b[a-z]+phot\b/gmi,
   /\b[a-z]+[kx-z]hup\b/gmi,
   /\b[a-z]+[h-kqux-z]ian\b/gmi,
   /\b[a-z]+[anrx-z]iar\b/gmi,
   /\b[a-z]+[evx-z]ica\b/gmi,
   /\b[a-z]+[aw]ick\b/gmi,
   ...
   /\b[a-z]+[gmx-z]ila\b/gmi,
   /\b[a-z]+[klyz]ile\b/gmi,
   /\b[a-z]+[hmu]ill\b/gmi,
   /\b[a-z]+[bhmsx-z]ilo\b/gmi,
   /\b[a-z]+[aehmx-z]ima\b/gmi,
   ...
   /\b[a-z]+e[cs][b-dfgijl-ru-xz]\b/gmi,
