export const NamesEndingRegEx: RegExp[] = [
   ...
   new RegExp(/\b[a-z]+[bgjmvx-z]eer\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[dx-z]sen\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+b[cdfhjkmpqstw-z][a-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+ll[b-kmnp-rt-xz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+t[bdfgjkmpqv-y][a-z]\b/, "gmi"),
