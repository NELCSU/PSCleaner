...
export const NamesEndingRegEx: RegExp[] = [
   ...
   /\b[a-z]+mrong\b/gmi,
   /\b[a-z]+oorty\b/gmi,
   /\b[a-z]+[abhik-prsuv]reet\b/gmi,
   /\b[a-z]+sche[lnrst]\b/gmi,
   /\b[a-z]+ssell\b/gmi,
   /\b[a-z]+shire\b/gmi,
   /\b[a-z]+slade\b/gmi,
   /\b[a-z]+stein\b/gmi,
   ...
   /\b[a-z]+[bcdghkmnprs]aill\b/gmi,
   /\b[a-z]*[bg-lmprsvw]anot\b/gmi,
   /\b[a-z]*[a-npr-wyz]aris\b/gmi,
   /\b[a-z]*[abdeghiklor-uvy]lena\b/gmi,
   /\b[a-z]*[bcdf-npr-z]orto\b/gmi,
   ...
   /\b[a-z]+[a-dghik-or-w]yll\b/gmi,
   /\b[a-z]+[a-cfijmnp-rt-z]yne\b/gmi,
   /\b[a-z]+[a-giknostwy]yre\b/gmi,
   /\b[a-z]+[b-hj-np-z]zen\b/gmi,
   /\b[a-z]+[dhj-musvw]zer\b/gmi,
   ...
   /\b[a-z]+ay[aehinoru]\b/gmi,
   /\b[a-z]+az[aiouz]\b/gmi,

   /\b[a-z]+ba[a-dh-kmopqtu-z]\b/gmi,
   /\b[a-z]+bb[aeiosuw]\b/gmi,
   /\b[a-z]+b[cr][iouy]\b/gmi,
   /\b[a-z]+b[dms][aeiouy]\b/gmi,
   /\b[a-z]+be[acgikjmnou-xz]\b/gmi,
   /\b[a-z]+bh[abce-z]\b/gmi,
   /\b[a-z]+bi[bi-loqruxz]\b/gmi,
   /\b[a-z]+bl[aiou]\b/gmi,
   /\b[a-z]+bo[ab-egiklmuv]\b/gmi,
   /\b[a-z]+bq[aeilou]\b/gmi,
   /\b[a-z]+bt[aehiouy]\b/gmi,
   /\b[a-z]+bu[ailmoprtuz]\b/gmi,
   /\b[a-z]+bw[aeilnorstuy]\b/gmi,
   /\b[a-z]+by[adeionrstu]\b/gmi,
   /\b[a-z]+b[fjknpvxz][aeiou]\b/gmi,
   ...
   /\b[a-z]+cf[aeio]\b/gmi,
   /\b[a-z]+ch[diotu]\b/gmi,
   /\b[a-z]+ci[bgiruw]\b/gmi,
   /\b[a-z]+cj[aeinouy]\b/gmi,
   /\b[a-z]+ck[aeiotu]\b/gmi,
   ...
   /\b[a-z]+ev[abcfliostuz]\b/gmi,
   /\b[a-z]+ew[adehiklou]\b/gmi,
   /\b[a-z]+ex[alosux]\b/gmi,
   /\b[a-z]+ey[abdfhik-ortu]\b/gmi,
   /\b[a-z]+ez[ah-losuz]\b/gmi,

   /\b[a-z]+fa[a-oquvwyz]\b/gmi,
   /\b[a-z]+fc[aehijouy]\b/gmi,
   /\b[a-z]+fd[aeiouty]\b/gmi,
   /\b[a-z]+fe[a-cf-mo-qt-vxz]\b/gmi,
   /\b[a-z]+ff[aeilortuz]\b/gmi,
   /\b[a-z]+fg[ehi]\b/gmi,
   /\b[a-z]+fi[e-kqru-wyz]\b/gmi,
   /\b[a-z]+f[bhjkmnz][aeiouy]\b/gmi,
   /\b[a-z]+fl[aikno]\b/gmi,
   ...
   /\b[a-z]+g[bz][aehiou]\b/gmi,
   /\b[a-z]+gd[aeiosuy]\b/gmi,
   /\b[a-z]+ge[bcf-kpqu-xz]\b/gmi,
   /\b[a-z]+gf[aeiou]\b/gmi,
   /\b[a-z]+gg[aeilosu]\b/gmi,
   /\b[a-z]+gh[adefhilnouz]\b/gmi,
   /\b[a-z]+gi[bd-fhi-kmoru-xz]\b/gmi,
   /\b[a-z]+gl[adilmu]\b/gmi,
   /\b[a-z]+gm[aehiortux]\b/gmi,
   /\b[a-z]+gn[aiou]\b/gmi,
   /\b[a-z]+go[a-mo-qu-z]\b/gmi,
   /\b[a-z]+gr[adhinotuz]\b/gmi,
   /\b[a-z]+gs[aehiouwz]\b/gmi,
   /\b[a-z]+gt[aeiouy]\b/gmi,
   /\b[a-z]+gu[a-df-lo-ru-xz]\b/gmi,
   /\b[a-z]+gw[adeil-orsuy]\b/gmi,
   /\b[a-z]+gy[abdeinoruw]\b/gmi,

   /\b[a-z]+ha[a-km-ru-z]\b/gmi,
   /\b[a-z]+h[bd][aehiouy]\b/gmi,
   /\b[a-z]+he[bcef-kmo-quvx-z]\b/gmi,
   /\b[a-z]+hi[abefh-loqru-z]\b/gmi,
   /\b[a-z]+h[gkv][aeiouy]\b/gmi,
   /\b[a-z]+hl[aiou]\b/gmi,
   /\b[a-z]+h[cfhjmptz][aeiou]\b/gmi,
   ...
   /\b[a-z]+ia[abfh-kmopu-z]\b/gmi,
   /\b[a-z]+ib[abhioruy]\b/gmi,
   /\b[a-z]+ic[hiou]\b/gmi,
   /\b[a-z]+id[cdf-np-rt-xz]\b/gmi,
   /\b[a-z]+ie[a-ceg-kno-qvyz]\b/gmi,
   /\b[a-z]+if[a-dg-ruv-wz]\b/gmi,
   /\b[a-z]+ig[b-dfgij-lp-ru-z]\b/gmi,
   /\b[a-z]+ih[aeiouy]\b/gmi,
   /\b[a-z]+ij[aeikou]\b/gmi,
   /\b[a-z]+ik[a-df-rt-xz]\b/gmi,
   /\b[a-z]+il[bcgipu]\b/gmi,
   /\b[a-z]+im[cdfh-nqrt-xz]\b/gmi,
   /\b[a-z]+in[im-ruwz]\b/gmi,
   /\b[a-z]+io[a-ce-ko-qu-z]\b/gmi,
   /\b[a-z]+ip[a-df-hklnopru-xz]\b/gmi,
   /\b[a-z]+iq[aeiou]\b/gmi,
   /\b[a-z]+ir[acfgijqnou-xz]\b/gmi,
   /\b[a-z]+is[bdfgijloqvwxz]\b/gmi,
   /\b[a-z]+it[acdgijlprt-xz]\b/gmi,
   /\b[a-z]+iu[en]\b/gmi,
   /\b[a-z]+iv[acgikouvz]\b/gmi,
   /\b[a-z]+iw[acgeimnorsuy]\b/gmi,
   /\b[a-z]+ix[aeity]\b/gmi,
   /\b[a-z]+iy[aino]\b/gmi,
   /\b[a-z]+iz[a-df-y]\b/gmi,

   /\b[a-z]+j[aeio][a-z]\b/gmi,
   /\b[a-z]+jb[abeiotuy]\b/gmi,
   /\b[a-z]+jc[aehikou]\b/gmi,
   /\b[a-z]+jd[aeilotuy]\b/gmi,
   /\b[a-z]+jh[aeiousy]\b/gmi,
   /\b[a-z]+jk[aeiklouy]\b/gmi,
   /\b[a-z]+jl[aeijouy]\b/gmi,
   /\b[a-z]+jn[aceior-uy]\b/gmi,
   /\b[a-z]+js[aeiouz]\b/gmi,
   /\b[a-z]+jt[adehinostu]\b/gmi,
   /\b[a-z]+jv[aeiosu]\b/gmi,
   /\b[a-z]+jy[aeiloruz]\b/gmi,
   /\b[a-z]+j[jz][adeiouy]\b/gmi,
   /\b[a-z]+ju[a-eg-pr-uwxz]\b/gmi,
   /\b[a-z]+j[fgmprwx][aeiou]\b/gmi,

   /\b[a-z]+ka[a-wyz]\b/gmi,
   /\b[a-z]+ke[abe-kmo-quvxz]\b/gmi,
   /\b[a-z]+kh[aeilnor-uy]\b/gmi,
   /\b[a-z]+ki[abcfh-mqrsuvwyz]\b/gmi,
   /\b[a-z]+kl[aiou]\b/gmi,
   /\b[a-z]+km[aeinouy]\b/gmi,
   /\b[a-z]+k[bdjknrz][aeiouy]\b/gmi,
   /\b[a-z]+ko[a-mopr-z]\b/gmi,
   /\b[a-z]+k[fgpq][aeiou]\b/gmi,
   /\b[a-z]+ks[aehikmosuz]\b/gmi,
   /\b[a-z]+kt[aiou]\b/gmi,
   /\b[a-z]+ku[a-fh-orstuwz]\b/gmi,
   /\b[a-z]+kv[aekiou]\b/gmi,
   /\b[a-z]+kw[aeinouvy]\b/gmi,
   /\b[a-z]+k[cx][aeiouyz]\b/gmi,
   /\b[a-z]+ky[adefhijl-or-uyz]\b/gmi,
   ...
   /\b[a-z]+l[hjkr][aeiou]\b/gmi,
   /\b[a-z]+lz[aeiouy]\b/gmi,
   /\b[a-z]+li[bf-moqru-z]\b/gmi,
   /\b[a-z]+lm[aeinou]\b/gmi,
   /\b[a-z]+ll[e-ituz]\b/gmi,
   /\b[a-z]+ln[aeinostuy]\b/gmi,
   /\b[a-z]+lo[abdefh-koqsuvxz]\b/gmi,
   /\b[a-z]+lp[aehiou]\b/gmi,
   /\b[a-z]+ls[ahiou]\b/gmi,
   /\b[a-z]+lt[aeioutz]\b/gmi,
   /\b[a-z]+lu[acdfh-ln-rt-wyz]\b/gmi,
   /\b[a-z]+lv[aiosuy]\b/gmi,
   /\b[a-z]+lw[aegimnorstuy]\b/gmi,
   /\b[a-z]+ly[abd-kmnortuwyz]\b/gmi,

   /\b[a-z]+ma[abd-kmoqru-wyz]\b/gmi,
   /\b[a-z]+mb[aeou]\b/gmi,
   ...
   /\b[a-z]+nb[aehioruy]\b/gmi,
   /\b[a-z]+nc[aijnqruz]\b/gmi,
   /\b[a-z]+nd[ilrtu]\b/gmi,
   /\b[a-z]+ne[bcf-kmpquvz]\b/gmi,
   /\b[a-z]+nf[aefiouy]\b/gmi,
   /\b[a-z]+ng[aciu]\b/gmi,
   /\b[a-z]+nh[eimnoprtuy]\b/gmi,
   /\b[a-z]+ni[efh-kqruvwyz]\b/gmi,
   /\b[a-z]+nj[aehikmnortuvy]\b/gmi,
   /\b[a-z]+nk[acehilnotuw]\b/gmi,
   /\b[a-z]+nl[aegiklnotu]\b/gmi,
   /\b[a-z]+nm[aeiouy]\b/gmi,
   /\b[a-z]+nn[ac-fh-lotuz]\b/gmi,
   /\b[a-z]+no[cf-ko-quvz]\b/gmi,
   /\b[a-z]+np[adeiouy]\b/gmi,
   /\b[a-z]+nr[aiou]\b/gmi,
   /\b[a-z]+ns[ahikou]\b/gmi,
   /\b[a-z]+nt[adeimruvwz]\b/gmi,
   /\b[a-z]+nu[a-df-knoqru-z]\b/gmi,
   /\b[a-z]+nv[adehil-or-uy]\b/gmi,
   /\b[a-z]+nw[aceghilmnorsuvy]\b/gmi,
   /\b[a-z]+nx[aehiouz]\b/gmi,
   /\b[a-z]+ny[adeh-knopr-uw-z]\b/gmi,
   /\b[a-z]+nz[eijklostuy]\b/gmi,

   /\b[a-z]+oa[abcg-josuvwyz]\b/gmi,
   /\b[a-z]+ob[abhiortuy]\b/gmi,
   /\b[a-z]+oc[aeghiloquxyz]\b/gmi,
   /\b[a-z]+od[adfhijl-oqrtuvwz]\b/gmi,
   /\b[a-z]+oe[bce-mopqs-xz]\b/gmi,
   /\b[a-z]+of[aefinouw]\b/gmi,
   /\b[a-z]+og[aegiou]\b/gmi,
   /\b[a-z]+oh[abde-ik-ortuvwy]\b/gmi,
   /\b[a-z]+oi[be-kmo-qu-z]\b/gmi,
   /\b[a-z]+oj[acdeg-knostuyz]\b/gmi,
   /\b[a-z]+ok[a-cfh-prt-xz]\b/gmi,
   /\b[a-z]+ol[cbhjm-puz]\b/gmi,
   /\b[a-z]+om[cf-noqru-xz]\b/gmi,
   /\b[a-z]+on[bcfhijl-ruwxz]\b/gmi,
   /\b[a-z]+oo[a-ceh-joqu-z]\b/gmi,
   /\b[a-z]+op[cfhijoptuv]\b/gmi,
   /\b[a-z]+oq[aeioqu]\b/gmi,
   /\b[a-z]+or[cf-jlopruvwz]\b/gmi,
   /\b[a-z]+os[acdgiklnpqru-xz]\b/gmi,
   /\b[a-z]+ot[abilrtnuvz]\b/gmi,
   /\b[a-z]+ou[a-ce-km-oqu-z]\b/gmi,
   /\b[a-z]+ow[ad-kmoprtuwxz]\b/gmi,
   /\b[a-z]+ov[acdghiknostuvz]\b/gmi,
   /\b[a-z]+ox[aeiotux]\b/gmi,
   /\b[a-z]+oy[acdegij-ortuwyz]\b/gmi,
   /\b[a-z]+oz[adhiklnosu]\b/gmi,
   ...
   /\b[a-z]+rd[adehiotu]\b/gmi,
   /\b[a-z]+re[bcfh-kouvz]\b/gmi,
   /\b[a-z]+rf[aefiou]\b/gmi,
   /\b[a-z]+rg[ahiu]\b/gmi,
   /\b[a-z]+rh[aimouy]\b/gmi,
   /\b[a-z]+ri[be-kqruvw]\b/gmi,
   /\b[a-z]+rj[aeiouy]\b/gmi,
   /\b[a-z]+rl[aefilotuz]\b/gmi,
   /\b[a-z]+rm[eimotu]\b/gmi,
   /\b[a-z]+rn[aeiknu]\b/gmi,
   /\b[a-z]+ro[acdhi-kquvz]\b/gmi,
   /\b[a-z]+rp[a-gj-ru-xz]\b/gmi,
   /\b[a-z]+r[kq][aeiou]\b/gmi,
   /\b[a-z]+rr[a-dfgi-qsuvwz]\b/gmi,
   /\b[a-z]+rs[acksuz]\b/gmi,
   /\b[a-z]+rt[aeilmtuz]\b/gmi,
   /\b[a-z]+ru[a-dfh-loqrt-z]\b/gmi,
   /\b[a-z]+rv[aiou]\b/gmi,
   /\b[a-z]+rw[adegil-prsuy]\b/gmi,
   /\b[a-z]+ry[adefilmnr-uw]\b/gmi,
   ...
   /\b[a-z]+ta[adfh-ko-qu-wz]\b/gmi,
   /\b[a-z]+t[bf][aeiouy]\b/gmi,
   /\b[a-z]+te[bcf-koqu-wz]\b/gmi,
   /\b[a-z]+tg[ahinorstuwy]\b/gmi,
   ...
   /\b[a-z]+t[cjkpxz][aeiou]\b/gmi,
   /\b[a-z]+tr[iu]\b/gmi,
   /\b[a-z]+ts[aehikou]\b/gmi,
   /\b[a-z]+tt[aiou]\b/gmi,
   ...
   /\b[a-z]+vcp\b/gmi,
   /\b[a-z]+v[djkv][aeiouy]\b/gmi,
   /\b[a-z]+ve[a-cefh-ko-qu-wz]\b/gmi,
   /\b[a-z]+vi[cf-ko-rt-wyz]\b/gmi,
   /\b[a-z]+v[lz][aeiou]\b/gmi,
   ...
   /\b[a-z]+wb[aeiloruy]\b/gmi,
   /\b[a-z]+wc[aehikosuwyz]\b/gmi,
   /\b[a-z]+wd[adeilnoru]\b/gmi,
   /\b[a-z]+we[ace-km-qu-z]\b/gmi,
   /\b[a-z]+wf[aefinortuy]\b/gmi,
   /\b[a-z]+wg[aeilou]\b/gmi,
   /\b[a-z]+w[hz][aeiouy]\b/gmi,
   /\b[a-z]+wi[a-fhj-lo-su-z]\b/gmi,
   /\b[a-z]+wk[aeiouyz]\b/gmi,
   /\b[a-z]+wl[acdefhkiou]\b/gmi,
   /\b[a-z]+wm[aeiopsuy]\b/gmi,
   /\b[a-z]+wn[acdeginotu]\b/gmi,
   /\b[a-z]+wo[adeioruw]\b/gmi,
   /\b[a-z]+w[jpqv][aeiou]\b/gmi,
   /\b[a-z]+wr[adeiknouw]\b/gmi,
   /\b[a-z]+ws[ahikostuz]\b/gmi,
   /\b[a-z]+wt[aeinotuy]\b/gmi,
   /\b[a-z]+wu[a-lnoq-z]\b/gmi,
   /\b[a-z]+ww[abeiotuyz]\b/gmi,
   /\b[a-z]+wy[ad-orsu]\b/gmi,
