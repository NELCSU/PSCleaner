export const NamesEndingRegEx: RegExp[] = [
   ...
   new RegExp(/\b[a-z]+[a-dg-lrx-z]ach\b/, "gmi"),
   new RegExp(/\b[a-z]+[hx-z]ado\b/, "gmi"),
   new RegExp(/\b[a-z]+[x-z]age\b/, "gmi"),
   new RegExp(/\b[a-z]+[nx-z]ago\b/, "gmi"),
   new RegExp(/\b[a-z]+[dx-z]ail\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[hx-z]all\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[afnqsx]ard\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[alx-z]cio\b/, "gmi"),
   new RegExp(/\b[a-z]+[ix-z]cot\b/, "gmi"),
   new RegExp(/\b[a-z]+[sx-z]dal\b/, "gmi"),
   new RegExp(/\b[a-z]+[ahx-z]dar\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[mx-z]ede\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[bgx-z]eer\b/, "gmi"),
   new RegExp(/\b[a-z]+[jx-z]eet\b/, "gmi"),
   new RegExp(/\b[a-z]+[hlx-z]ego\b/, "gmi"),
   new RegExp(/\b[a-z]+[sx-z]ein\b/, "gmi"),
   new RegExp(/\b[a-z]+[nx-z]eir\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[abdlw-z]ena\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[ox-z]ish\b/, "gmi"),
