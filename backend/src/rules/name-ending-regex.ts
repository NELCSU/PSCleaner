export const NamesEndingRegEx: RegExp[] = [
   ...
   /\b[a-z]+j[a-ce-ik-os-vxy][a-z]\b/gmi,
   /\b[a-z]+jc[a-km-z]\b/gmi,
   /\b[a-z]+jd[ac-z]\b/gmi,
   ...
   /\b[a-z]+ka[a-z]\b/gmi,
   /\b[a-z]+k[bcfghjmprv-z][a-z]\b/gmi,
   /\b[a-z]+kd[ac-z]\b/gmi,
