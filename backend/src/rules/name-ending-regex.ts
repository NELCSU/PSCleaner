export const NamesEndingRegEx: RegExp[] = [
   new RegExp(/[a-z]*[À-ÖØ-öø-ÿãñõțũąğịňōıŚạşęăầẩőếšảłộơńėəāţș]+[a-z]*/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[hx-z]ami\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[akuvx-z]ash\b/, "gmi"),
   new RegExp(/\b[a-z]+[nx-z]ass\b/, "gmi"),
   new RegExp(/\b[a-z]+[w-z]ate\b/, "gmi"),
   new RegExp(/\b[a-z]+[adknqrtx-z]ath\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[ac-jmnvx-z]een\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[kx-z]era\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[x-z]esa\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[bx-z]eth\b/, "gmi"),
   new RegExp(/\b[a-z]+[kx-z]eti\b/, "gmi"),
   new RegExp(/\b[a-z]+[ux-z]eto\b/, "gmi"),
   new RegExp(/\b[a-z]+[ax-z]eze\b/, "gmi"),
   new RegExp(/\b[a-z]+[nx-z]far\b/, "gmi"),
   new RegExp(/\b[a-z]+[an]gam\b/, "gmi"),
   new RegExp(/\b[a-z]+[inox-z]gan\b/, "gmi"),
   new RegExp(/\b[a-z]+[axz]gen\b/, "gmi"),
   new RegExp(/\b[a-z]+[nx-z]gum\b/, "gmi"),
   new RegExp(/\b[a-z]+[bx-z]hal\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[hjx-z]ian\b/, "gmi"),
   new RegExp(/\b[a-z]+[rx-z]iar\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[adeux-z]ike\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[a-ekloprsw-z]ina\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[ax-z]lam\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[aux-z]lla\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[ux-z]oli\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[jkmx-z]oor\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[ax-z]rat\b/, "gmi"),
   new RegExp(/\b[a-z]+[htx-z]ree\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+c[b-dfgjmpqsvwx][a-z]\b/, "gmi"),
