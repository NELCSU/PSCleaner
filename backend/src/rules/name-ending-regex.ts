export const NamesEndingRegEx: RegExp[] = [
   ...
   new RegExp(/\b[a-z]+castle\b/, "gmi"),
   new RegExp(/\b[a-z]+meadow\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+hayes\b/, "gmi"),
   new RegExp(/\b[a-z]+hedge\b/, "gmi"),
   new RegExp(/\b[a-z]+hurst\b/, "gmi"),
   new RegExp(/\b[a-z]+leaze\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+mrong\b/, "gmi"),
   new RegExp(/\b[a-z]+oorty\b/, "gmi"),
   new RegExp(/\b[a-z]+preet\b/, "gmi"),
   new RegExp(/\b[a-z]+scher\b/, "gmi"),
   new RegExp(/\b[a-z]+shire\b/, "gmi"),
   new RegExp(/\b[a-z]+slade\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+dack\b/, "gmi"),
   new RegExp(/\b[a-z]+[abd-mpqtux-z]ado\b/, "gmi"),
   new RegExp(/\b[a-z]+[x-z]age\b/, "gmi"),
   new RegExp(/\b[a-z]+[nx-z]ago\b/, "gmi"),
   new RegExp(/\b[a-z]+[bdgyz]aha\b/, "gmi"),
   new RegExp(/\b[a-z]+[dfhx-z]ail\b/, "gmi"),
   new RegExp(/\b[a-z]+[ix-z]aim\b/, "gmi"),
   new RegExp(/\b[a-z]+[bnsux-z]ain\b/, "gmi"),
   new RegExp(/\b[a-z]+[dgkmwx-z]air\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[a-cklmsvw-z]alo\b/, "gmi"),
   new RegExp(/\b[a-z]+[adhk-nsuw-z]ama\b/, "gmi"),
   new RegExp(/\b[a-z]+[hx-z]ame\b/, "gmi"),
   new RegExp(/\b[a-z]+[hksx-z]ami\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[brx-z]any\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[aux-z]dee\b/, "gmi"),
   new RegExp(/\b[a-z]+udem\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+eega\b/, "gmi"),
   new RegExp(/\b[a-z]+[h-lx-z]ego\b/, "gmi"),
   new RegExp(/\b[a-z]+[blswx-z]ein\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[kl]ema\b/, "gmi"),
   new RegExp(/\b[a-z]+[gx-z]eme\b/, "gmi"),
   new RegExp(/\b[a-z]+iemo\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+werk\b/, "gmi"),
   new RegExp(/\b[a-z]+derl\b/, "gmi"),
   new RegExp(/\b[a-z]+[kwx-z]ern\b/, "gmi"),
   new RegExp(/\b[a-z]+[i-kruvxy]ero\b/, "gmi"),
   new RegExp(/\b[a-z]+[fgmwx-z]ert\b/, "gmi"),
   new RegExp(/\b[a-z]+[iox-z]esa\b/, "gmi"),
   new RegExp(/\b[a-z]+[bx-z]ese\b/, "gmi"),
   new RegExp(/\b[a-z]+[dnx-z]esh\b/, "gmi"),
   new RegExp(/\b[a-z]+[be-lpuwx-z]eta\b/, "gmi"),
   new RegExp(/\b[a-z]+[kl]ete\b/, "gmi"),
   new RegExp(/\b[a-z]+[blnpx-z]eth\b/, "gmi"),
   new RegExp(/\b[a-z]+[gkx-z]eti\b/, "gmi"),
   new RegExp(/\b[a-z]+[ux-z]eto\b/, "gmi"),
   new RegExp(/\b[a-z]+[ly]eve\b/, "gmi"),
   new RegExp(/\b[a-z]+zeye\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+phot\b/, "gmi"),
   new RegExp(/\b[a-z]+[kx-z]hup\b/, "gmi"),
   new RegExp(/\b[a-z]+[h-kqux-z]ian\b/, "gmi"),
   new RegExp(/\b[a-z]+[anrx-z]iar\b/, "gmi"),
   new RegExp(/\b[a-z]+[evx-z]ica\b/, "gmi"),
   new RegExp(/\b[a-z]+[aw]ick\b/, "gmi"),
   new RegExp(/\b[a-z]+[adeux-z]ida\b/, "gmi"),
   new RegExp(/\b[a-z]+[jy]ide\b/, "gmi"),
   new RegExp(/\b[a-z]+[any]iel\b/, "gmi"),
   new RegExp(/\b[a-z]+diem\b/, "gmi"),
   new RegExp(/\b[a-z]+[aeuvy]ier\b/, "gmi"),
   new RegExp(/\b[a-z]+[djlx-z]ieu\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[a-ehkloprsv-z]ina\b/, "gmi"),
   new RegExp(/\b[a-z]+rinc\b/, "gmi"),
   new RegExp(/\b[a-z]+[jq]ing\b/, "gmi"),
   new RegExp(/\b[a-z]+gink\b/, "gmi"),
   new RegExp(/\b[a-z]+zior\b/, "gmi"),
   new RegExp(/\b[a-z]+dipe\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[imr]ito\b/, "gmi"),
   new RegExp(/\b[a-z]+hity\b/, "gmi"),
   new RegExp(/\b[a-z]+[ej]ken\b/, "gmi"),
   new RegExp(/\b[a-z]+jker\b/, "gmi"),
   new RegExp(/\b[a-z]+[ix-z]kie\b/, "gmi"),
   new RegExp(/\b[a-z]+[hu]kin\b/, "gmi"),
   new RegExp(/\b[a-z]+[nx-z]kit\b/, "gmi"),
   new RegExp(/\b[a-z]+blad\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+onio\b/, "gmi"),
   new RegExp(/\b[a-z]+[aox-z]non\b/, "gmi"),
   new RegExp(/\b[a-z]+[ao]not\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+iora\b/, "gmi"),
   new RegExp(/\b[a-z]+[bfjox-z]ord\b/, "gmi"),
   new RegExp(/\b[a-z]+jore\b/, "gmi"),
   new RegExp(/\b[a-z]+[kopvx-z]orn\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[ahjs]oud\b/, "gmi"),
   new RegExp(/\b[a-z]+[al]oul\b/, "gmi"),
   new RegExp(/\b[a-z]+[jx-z]our\b/, "gmi"),
   new RegExp(/\b[a-z]+[ahrx-z]owe\b/, "gmi"),
   new RegExp(/\b[a-z]+[tx-z]own\b/, "gmi"),
   new RegExp(/\b[a-z]+[nt]pal\b/, "gmi"),
   new RegExp(/\b[a-z]+[ipx-z]pan\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[ahstx-z]ree\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[hsx-z]rit\b/, "gmi"),
   new RegExp(/\b[a-z]+[ax-z]rma\b/, "gmi"),
   new RegExp(/\b[a-z]+urny\b/, "gmi"),
   new RegExp(/\b[a-z]+orof\b/, "gmi"),
   new RegExp(/\b[a-z]+trog\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[ds-ux-z]sen\b/, "gmi"),
   new RegExp(/\b[a-z]+[sx-z]sey\b/, "gmi"),
   new RegExp(/\b[a-z]+rsic\b/, "gmi"),
   new RegExp(/\b[a-z]+[ax-z]sie\b/, "gmi"),
   new RegExp(/\b[a-z]+[sxy]sim\b/, "gmi"),
   new RegExp(/\b[a-z]+asit\b/, "gmi"),
   new RegExp(/\b[a-z]+[rt]sma\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[aehu-z]tar\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+a[oy][a-rt-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+ab[a-rt-wyz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+c[bgjqsvwx][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+cc[abd-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+cd[abd-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+ce[bcf-kmoqu-xz]\b/, "gmi"),
   new RegExp(/\b[a-z]+cf[a-km-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+d[bfhjkmqvwxz][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+dc[a-mo-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+dd[a-ce-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+h[b-dfgjknp-rv-xz][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+he[bcef-ko-quvxyz]\b/, "gmi"),
   new RegExp(/\b[a-z]+hh[a-gi-ou-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+hu[a-oqru-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+j[a-ik-z][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+jj[a-ik-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+kk[a-jl-rt-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+l[dkmp][a-rt-xz]\b/, "gmi"),
   new RegExp(/\b[a-z]+lb[a-rt-vxz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+mm[b-df-ln-xz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+n[fmpqv-x][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+nb[a-fh-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+nn[a-fh-mo-rt-xz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+pp[a-df-nq-xz]\b/, "gmi"),
   new RegExp(/\b[a-z]+p[qs][a-df-np-xz]\b/, "gmi"),
   new RegExp(/\b[a-z]+pr[a-df-np-wz]\b/, "gmi"),
   new RegExp(/\b[a-z]+pt[a-ce-gj-np-rtv-xz]\b/, "gmi"),
   new RegExp(/\b[a-z]+pu[a-ce-moqru-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+py[a-kn-qt-z]\b/, "gmi"),

   new RegExp(/\b[a-z]+q[a-pr-z][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+qq[a-pr-z]\b/, "gmi"),

   new RegExp(/\b[a-z]+ra[acdfh-koqruvz]\b/, "gmi"),
   new RegExp(/\b[a-z]+r[bdfk][a-rt-xz]\b/, "gmi"),
   new RegExp(/\b[a-z]+rc[a-dfgi-xz]\b/, "gmi"),
   new RegExp(/\b[a-z]+re[bcf-koquvz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+s[dfgjqrwz][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+sb[ac-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+ss[a-df-np-rt-xz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+te[bcf-koqu-wz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+vv[a-uw-z]\b/, "gmi"),
  
   new RegExp(/\b[a-z]+wa[a-qt-vz]\b/, "gmi"),
   new RegExp(/\b[a-z]+w[bcf-hjmpqvx-z][a-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+ww[a-vx-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+y[cf-kqu-x][a-z]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+yy[a-xz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+z[b-df-kmnp-y][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+zz[a-y]\b/, "gmi")
];