export const NamesEndingRegEx: RegExp[] = [
   ...
   /\b[a-z]+[ae-gi-kmos-wyz]eck\b/gmi,
   ...
   /\b[a-z]+f[b-dghjkmnqsw-z][a-z]\b/gmi,
   ...
   /\b[a-z]+h[bdfgjknpqv-xz][a-z]\b/gmi,
   ...
   /\b[a-z]+rr[a-df-qs-wz]\b/gmi,
   /\b[a-z]+rs[a-dfgj-np-su-wz]\b/gmi,
