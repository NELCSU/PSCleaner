...
// HIGH
/[\d-]+\shigh\sfell\b/gi,
/(?<=(?:TS10|LA21)).{2,25}\bhigh\sfell\b/gi,
/\bhigh\sfell\b(?=.{2,20}(?:TS10|LA21))/gi,

// HILL
/[\d-]+\shill\s(?:close|fall|tops?|view|walk)\b/gi,
...
// PARK
/[\d-]+\spark\s(?:gate|homes|north|place|ride|road|view|walk|w[ae]ll|west|wood)\b/gi,
