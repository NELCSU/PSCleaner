...
export const LocationTheRegEx: RegExp[] = [
  ...
  /\bThe\sBu(?:cklers|dding|ffer|ll\sRing|rns?|tchery|tts)\b/gm,
  ...
  /\bThe\sCh(?:ild['‘’`s]{1,2}\sSeat|imes|imneys|ocolate\sWorks|ristian)\b/gm,
  ...
  /\bThe\sFi(?:elders|ndings|rs|rst|sheries|sher[sy]|ve\sSprings)\b/gm,
  ...
  /\bThe\sPat(?:ch|ches|hway(?:\sFields)?|hfinders?|ios)\b/gm,
  ...
  /\bThe\sSho(?:als?|e|ots|ps|res?|rt|t)\b/gm,
  ...
  /\bThe\sSl(?:ing|ips?|ipway|ithers|obs|opes|ough)\b/gm,
  ...
  /\bThe\sStr(?:eam|eet|ing|ipe?)\b/gm,
  ...
  /\bThe\sTow(?:ers?|n|path)\b/gm,
  /\bThe\sTo(?:e|ll|llgate|mb|mbstone|n|ngues|ons|piary|ppings|re|rs)\b/gm,
