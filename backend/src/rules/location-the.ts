export const LocationTheRegEx: RegExp[] = [
  ...
  /\bThe\sBo(?:ar|at|g|oks|ot|re|rder|ttom|ught|ulevard|unds?|undaries|undary|wl)\b/gm,
  ...
  /\bThe\sCom(?:mons?|munity\sCollege|pass)\b/gm,
  /\bThe\sCon(?:duit|nection|stables|suls)\b/gm,
  /\bThe\sCop(?:pice|se)?\b/gm,
  /\bThe\sCou(?:nty|rse|rtrooms|rts?|rtyards?)\b/gm,
  /\bThe\sCo(?:-?[Oo]perative|ast(?:\sGuards)?|llege|rn|rners?|rnfields|ttage|w)\b/gm,
  ...
  /\bThe\sOlde?\s(?:Stubble|Tennis\sCourts|Vinery|Warehouse|Wife)\b/gm,
  ...
  /\bThe\sPe(?:ntagon|ppercorns)\b/gm,
  ...
  /\bThe\sRed(?:\sMaids['‘’`]?|dings|woods)\b/gm,
  ...
  /\bThe\sSla(?:cks?|de|ke|p|ngs|tes?|ughters)\b/gm,
  ...
  /\bThe\sSt(?:ocks|udios?|udy|yle)\b/gm,
