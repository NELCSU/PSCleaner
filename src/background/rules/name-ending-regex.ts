export const NamesEndingRegEx: RegExp[] = [
   ...
   new RegExp(/\b[a-z]+a(?:ard|cio|dar|gam|gen|hat|ick|ier|igh|ina|ir[dnt]|ite|lla|man|ngi|non|nth|ona|ra[mnt]|ris|rma|san|sor|tsu|uer|ugh)\b/, "gmi"),
   new RegExp(/\b[a-z]+b(?:ach|ain|eer|hat|oon|oto|uil|ury)\b/, "gmi"),
   new RegExp(/\b[a-z]+c(?:hit|hon|ote|z[a-z]+)\b/, "gmi"),
   new RegExp(/\b[a-z]+d(?:ach|ail|ale|ee[np]|en[ae]|hat|ida|ike|ong|ra[mns]|uge|uth)\b/, "gmi"),
   new RegExp(/\b[a-z]+e(?:cia|ere|ier|lan|sor|ugh|var)\b/, "gmi"),
   new RegExp(/\b[a-z]+f(?:ar[dm]|el[dl]|eng|or[dt])\b/, "gmi"),
   new RegExp(/\b[a-z]+g(?:ach|ang|eer|ell|oon|ton)\b/, "gmi"),
   new RegExp(/\b[a-z]+h(?:ach|ais|all|ang|dar|dis|eng|eta|ige|ill|imi|ler|ong|ria|tar|ula|u[mr]y)\b/, "gmi"),
   new RegExp(/\b[a-z]+i(?:[ao]ng|ar[et]|cot|ech|e[nr]e|gan|mma|n[dh]a|ran|ute)\b/, "gmi"),
   new RegExp(/\b[a-z]+j(?:eet|ian|ith|oor|zen)\b/, "gmi"),
   new RegExp(/\b[a-z]+k(?:ang|era|ina|ong|oo[lr]|orn|ote|won)\b/, "gmi"),
   new RegExp(/\b[a-z]+l(?:[ae]ch|ieu|lan|uge|und)\b/, "gmi"),
   new RegExp(/\b[a-z]+m(?:ang|ead|ede|een|ere|ill|iry|oor|oto|pil)\b/, "gmi"),
   new RegExp(/\b[a-z]+n(?:ago|ass|ath|cia|esh|ga[mn]|gum|hoe|kit|ver)\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+u(?:ang|ch[ae]|din|ero|eto|ill|lis|tin|tte)\b/, "gmi"),
   new RegExp(/\b[a-z]+v(?:el[ad]|on[ay])\b/, "gmi"),
   new RegExp(/\b[a-z]+w(?:[ae]ld|ang|ate|ena|ern|ick|ina|ong|ood)\b/, "gmi"),
   new RegExp(/\b[a-z]+y(?:age|ama|ang|ide|lan|sen|the)\b/, "gmi"),
