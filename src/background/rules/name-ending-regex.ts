export const NamesEndingRegEx: RegExp[] = [
   ...
   new RegExp(/\b[a-z]+a(?:ard|cio|dar|gen|hat|ier|igh|ir[dnt]|ite|ngi|ram|ris|sor|uer)\b/, "gmi"),
   new RegExp(/\b[a-z]+b(?:ach|ain|eer|hat|oto|uil|ury)\b/, "gmi"),
   new RegExp(/\b[a-z]+c(?:ote|z[a-z]+)\b/, "gmi"),
   new RegExp(/\b[a-z]+d(?:ach|ail|ale|eep|ene|hat|ida|ike|ran|uge)\b/, "gmi"),
   new RegExp(/\b[a-z]+e(?:cia|ere|ier|sor)\b/, "gmi"),
   new RegExp(/\b[a-z]+f(?:ar[dm]|el[dl]|or[dt])\b/, "gmi"),
   new RegExp(/\b[a-z]+g(?:ach|eer|ell|ton)\b/, "gmi"),
   new RegExp(/\b[a-z]+h(?:ach|ais|all|eng|eta|ill|imi|ler|ong|ria|tar|ury)\b/, "gmi"),
   new RegExp(/\b[a-z]+i(?:ar[et]|ech|ene|gan|ute)\b/, "gmi"),
   new RegExp(/\b[a-z]+j(?:oor)\b/, "gmi"),
   new RegExp(/\b[a-z]+k(?:oor|orn)\b/, "gmi"),
   new RegExp(/\b[a-z]+l(?:[ae]ch|ieu|lan|und)\b/, "gmi"),
   new RegExp(/\b[a-z]+m(?:ead|ede|een|ere|ill|oor)\b/, "gmi"),
   new RegExp(/\b[a-z]+n(?:ago|ass|cia|gam|hoe|ver)\b/, "gmi"),
   new RegExp(/\b[a-z]+o(?:nda|san|tie|urn|yle)\b/, "gmi"),
   new RegExp(/\b[a-z]+p(?:ark|ong|orn)\b/, "gmi"),
   new RegExp(/\b[a-z]+r(?:ach|ell|ina|ras)\b/, "gmi"),
   new RegExp(/\b[a-z]+s(?:don|lea|ola|und)\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+w(?:[ae]ld|ate|ena|ern|ick|ina|ong|ood)\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+ha[ac-km-ru-z]\b/, "gmi"),
