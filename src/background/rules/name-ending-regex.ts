export const NamesEndingRegEx: RegExp[] = [
   ...
   new RegExp(/\b[a-z]+h(?:urst)\b/, "gmi"),
   new RegExp(/\b[a-z]+s(?:tein)\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+bain\b/, "gmi"),
   new RegExp(/\b[a-z]+wair\b/, "gmi"),
   new RegExp(/\b[a-z]+hais\b/, "gmi"),
   new RegExp(/\b[a-z]+wald\b/, "gmi"),
   new RegExp(/\b[a-z]+[adgqv-z]ale\b/, "gmi"),
   new RegExp(/\b[a-z]+hall\b/, "gmi"),
   new RegExp(/\b[a-z]+yalo\b/, "gmi"),
   new RegExp(/\b[a-z]+[aw-z]ama\b/, "gmi"),
   new RegExp(/\b[a-z]+hame\b/, "gmi"),
   new RegExp(/\b[a-z]+eamo\b/, "gmi"),
   new RegExp(/\b[a-z]+samy\b/, "gmi"),
   new RegExp(/\b[a-z]+[abd-gjkm-quw-z]ane\b/, "gmi"),
   new RegExp(/\b[a-z]+[a-kmnqu-z]ang\b/, "gmi"),
   new RegExp(/\b[a-z]+[afnqx]ard\b/, "gmi"),
   new RegExp(/\b[a-z]+iare\b/, "gmi"),
   new RegExp(/\b[a-z]+park\b/, "gmi"),
   new RegExp(/\b[a-z]+farm\b/, "gmi"),
   new RegExp(/\b[a-z]+iart\b/, "gmi"),
   new RegExp(/\b[a-z]+nase\b/, "gmi"),
   new RegExp(/\b[a-z]+nass\b/, "gmi"),
   new RegExp(/\b[a-z]+wate\b/, "gmi"),
   new RegExp(/\b[a-z]+[anqrtx-z]ath\b/, "gmi"),
   new RegExp(/\b[a-z]+kaur\b/, "gmi"),
   new RegExp(/\b[a-z]+ucha\b/, "gmi"),
   new RegExp(/\b[a-z]+uche\b/, "gmi"),
   new RegExp(/\b[a-z]+[ejknqw-z]cia\b/, "gmi"),
   new RegExp(/\b[a-z]+acio\b/, "gmi"),
   new RegExp(/\b[a-z]+icot\b/, "gmi"),
   new RegExp(/\b[a-z]+[ah]dar\b/, "gmi"),
   new RegExp(/\b[a-z]+adee\b/, "gmi"),
   new RegExp(/\b[a-z]+udin\b/, "gmi"),
   new RegExp(/\b[a-z]+hdis\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[lz]ile\b/, "gmi"),
   new RegExp(/\b[a-z]+[hmu]ill\b/, "gmi"),
   new RegExp(/\b[a-z]+[hm]ilo\b/, "gmi"),
   new RegExp(/\b[a-z]+himi\b/, "gmi"),
   new RegExp(/\b[a-z]+[aekrsw-z]ina\b/, "gmi"),
   new RegExp(/\b[a-z]+aird\b/, "gmi"),
   new RegExp(/\b[a-z]+airn\b/, "gmi"),
   new RegExp(/\b[a-z]+airt\b/, "gmi"),
   new RegExp(/\b[a-z]+miry\b/, "gmi"),
   new RegExp(/\b[a-z]+[adhu-z]isa\b/, "gmi"),
   new RegExp(/\b[a-z]+liso\b/, "gmi"),
   new RegExp(/\b[a-z]+[ao]ite\b/, "gmi"),
   new RegExp(/\b[a-z]+jith\b/, "gmi"),
   new RegExp(/\b[a-z]+[i]kie\b/, "gmi"),
   new RegExp(/\b[a-z]+nkit\b/, "gmi"),
   new RegExp(/\b[a-z]+hlag\b/, "gmi"),
   new RegExp(/\b[a-z]+[elu-z]lan\b/, "gmi"),
   new RegExp(/\b[a-z]+alar\b/, "gmi"),
   new RegExp(/\b[a-z]+[as-z]lea\b/, "gmi"),
   new RegExp(/\b[a-z]+hler\b/, "gmi"),
   new RegExp(/\b[a-z]+ulis\b/, "gmi"),
   new RegExp(/\b[a-z]+alla\b/, "gmi"),
   new RegExp(/\b[a-z]+[lw-z]lum\b/, "gmi"),
   new RegExp(/\b[a-z]+aman\b/, "gmi"),
   new RegExp(/\b[a-z]+imma\b/, "gmi"),
   new RegExp(/\b[a-z]+omme\b/, "gmi"),
   new RegExp(/\b[a-z]+[io]nda\b/, "gmi"),
   new RegExp(/\b[a-z]+[o]nde\b/, "gmi"),
   new RegExp(/\b[a-z]+ondo\b/, "gmi"),
   new RegExp(/\b[a-z]+ynen\b/, "gmi"),
   new RegExp(/\b[a-z]+hney\b/, "gmi"),
   new RegExp(/\b[a-z]+onge\b/, "gmi"),
   new RegExp(/\b[a-z]+angi\b/, "gmi"),
   new RegExp(/\b[a-z]+engo\b/, "gmi"),
   new RegExp(/\b[a-z]+inha\b/, "gmi"),
   new RegExp(/\b[a-z]+anon\b/, "gmi"),
   new RegExp(/\b[a-z]+anth\b/, "gmi"),
   new RegExp(/\b[a-z]+enza\b/, "gmi"),
   new RegExp(/\b[a-z]+[a-gi-km-qs-z]obe\b/, "gmi"),
   new RegExp(/\b[a-z]+toft\b/, "gmi"),
   new RegExp(/\b[a-z]+noke\b/, "gmi"),
   new RegExp(/\b[a-z]+[gs]ola\b/, "gmi"),
   new RegExp(/\b[a-z]+holt\b/, "gmi"),
   new RegExp(/\b[a-z]+goma\b/, "gmi"),
   new RegExp(/\b[a-z]+[a-hv]ona\b/, "gmi"),
   new RegExp(/\b[a-z]+[ac-fh-km-qu-z]ong\b/, "gmi"),
   new RegExp(/\b[a-z]+vony\b/, "gmi"),
   new RegExp(/\b[a-z]+wood\b/, "gmi"),
   new RegExp(/\b[a-z]+loof\b/, "gmi"),
   new RegExp(/\b[a-z]+[kp]ool\b/, "gmi"),
   new RegExp(/\b[a-z]+boom\b/, "gmi"),
   new RegExp(/\b[a-z]+[bg]oon\b/, "gmi"),
   new RegExp(/\b[a-z]+[jkm]oor\b/, "gmi"),
   new RegExp(/\b[a-z]+loot\b/, "gmi"),
   new RegExp(/\b[a-z]+gope\b/, "gmi"),
   new RegExp(/\b[a-z]+[fjo]ord\b/, "gmi"),
   new RegExp(/\b[a-z]+[kp]orn\b/, "gmi"),
   new RegExp(/\b[a-z]+[fo]ort\b/, "gmi"),
   new RegExp(/\b[a-z]+[cgk]ote\b/, "gmi"),
   new RegExp(/\b[a-z]+[bmk]oto\b/, "gmi"),
   new RegExp(/\b[a-z]+howe\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[aor]san\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+htar\b/, "gmi"),
   new RegExp(/\b[a-z]+[ey]the\b/, "gmi"),
   new RegExp(/\b[a-z]+otie\b/, "gmi"),
   new RegExp(/\b[a-z]+[su]tin\b/, "gmi"),
   new RegExp(/\b[a-z]+[cdf-hrw-z]ton\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+el[bceghjknoqru-xz]\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+ui[fh-kqrsu-y]\b/, "gmi"),
   new RegExp(/\b[a-z]+u[jqwxz][a-z]\b/, "gmi"),
   new RegExp(/\b[a-z]+uk[a-df-xz]\b/, "gmi"),
   new RegExp(/\b[a-z]+ul[cgh-jmnqru-xz]\b/, "gmi"),
