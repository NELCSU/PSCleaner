export const NamesEndingRegEx: RegExp[] = [
   ...
   new RegExp(/\b[a-z]+[a-cklw-z]alo\b/, "gmi"),
   new RegExp(/\b[a-z]+[akw-z]ama\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[a-kl-qt-z]ang\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+beba\b/, "gmi"),
   new RegExp(/\b[a-z]+cebo\b/, "gmi"),
   new RegExp(/\b[a-z]+[bilu-z]ech\b/, "gmi"),
   new RegExp(/\b[a-z]+mede\b/, "gmi"),
   new RegExp(/\b[a-z]+cedo\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+dimo\b/, "gmi"),
   new RegExp(/\b[a-z]+[aeklprsw-z]ina\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[egsx-z]ola\b/, "gmi"),
   new RegExp(/\b[a-z]+holt\b/, "gmi"),
   new RegExp(/\b[a-z]+[bg]oma\b/, "gmi"),
   new RegExp(/\b[a-z]+kome\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+utle\b/, "gmi"),
   new RegExp(/\b[a-z]+[cdf-hlp-rw-z]ton\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[adhklrx-z]ula\b/, "gmi"),
