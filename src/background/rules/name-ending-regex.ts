export const NamesEndingRegEx: RegExp[] = [
   ...
   new RegExp(/\b[a-z]+[hms]ilo\b/, "gmi"),
   new RegExp(/\b[a-z]+zima\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[jrx-z]ith\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[aei]ngo\b/, "gmi"),
   ...
   new RegExp(/\b[a-z]+[asx-z]ung\b/, "gmi"),
